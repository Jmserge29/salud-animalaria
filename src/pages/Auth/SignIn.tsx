...
export const SignIn = () => {
  return (
    ...
    <div className="p-4 sm:p-7">
        ...
        <h1 className="block text-2xl font-bold text-gray-800 ">Iniciar Sesión</h1>
        <p className="mt-2 text-sm text-gray-600">
            Aún no estás registrado?
            <a className="text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium ml-2" href="/sign-up">
            Registrate aquí
            </a>
        </p>
        </div>
        ...
        <form>
            ...
            <button type="submit" className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">Iniciar Sesión</button>
            </div>
        </form>
        </div>
    </div>
